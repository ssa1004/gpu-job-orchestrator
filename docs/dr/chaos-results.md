...
| 2026-05-16 | 02 postgres-delay (재) | 동일 | 통과 | 0% | 290ms | - |
| 2026-05-18 | 03 kafka-partition | Outbox 자동 회복 | 통과 | 0% | 평소 | publish lag 5분 동안 누적, 1분 내 회복 |
| 2026-05-19 | 04 worker-cpu-stress | 콜백 재시도 성공 | 통과 | - | - | 재시도 평균 2.3회 |
| 2026-05-20 | 05 gpu-node-drain | Job 자동 재제출 | 부분 실패 | - | - | 재제출 로직 timeout 미구현. ADR-FUTURE 추가 |
